...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    console.log(27, this.http.get<Hero[]>(this.heroesUrl));
    return this.http.get<Hero[]>(this.heroesUrl)
      .pipe(
        // The RxJs `tap()` operator enables this ability by looking at the observable values, 
        // doing something with those values, and passing them along.
        // `_` is a don't care or ignored or unused parameter
